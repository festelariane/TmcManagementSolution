...
namespace Tmc.Data.Initializers
{
        ...
        public void InitializeDatabase(TContext context)
        {
            ...
            if(dbExists)
            {
                ...
                if (_tablesToValidate != null && _tablesToValidate.Length > 0)
                {
                    ...
                    shouldCreateTable = !existingTableNames.Intersect(_tablesToValidate, StringComparer.InvariantCultureIgnoreCase).Any();
                }
                else
                {
                    ...
                    shouldCreateTable = numberOfTables == 0;
                }
